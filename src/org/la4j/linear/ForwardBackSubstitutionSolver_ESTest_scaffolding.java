...
public class ForwardBackSubstitutionSolver_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.la4j.linear.ForwardBackSubstitutionSolver"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(ForwardBackSubstitutionSolver_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "org.la4j.operation.ooplace.OoPlaceInnerProduct$1",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.util.Enumeration", false, ForwardBackSubstitutionSolver_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.la4j.vector.functor.VectorFunction", false, ForwardBackSubstitutionSolver_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(ForwardBackSubstitutionSolver_ESTest_scaffolding.class.getClassLoader()); 
